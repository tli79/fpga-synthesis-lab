...
HD_PWD='D:/Fall 2022/FPGA/SPI/SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab07.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab07.tcl -notrace
